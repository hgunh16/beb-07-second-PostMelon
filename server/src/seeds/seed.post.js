...
const seedPost = [
  {
    ...
    views: 135,
    writer: mongoose.mongo.ObjectId('63b63d921225e1ff1cda00a7'),
  },
  {
    title: '내가 좋아하는 음악 best 10',
    content: '1. music1 2. music2 3. music3',
    views: 291,
    writer: mongoose.mongo.ObjectId('63b63d921225e1ff1cda00a8'),
  },
  {
    title: '지칠 때 잠깐의 휴식을 주는 노래들',
    content: 'in the forest, flying to the sky',
    views: 16472,
    writer: mongoose.mongo.ObjectId('63b63d921225e1ff1cda00a9'),
  },
  {
